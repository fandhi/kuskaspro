            ...
            <ul id="search-result" class=" media-list">
                <li class="media result-1">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"><a href="">Suparjo - Tukang kuras toren</a></h4>
                ...
                <li class="media result-2">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"><a href="">Suparjo - Tukang kebun</a></h4>
                        <div class="result-toggle">
                            <article>
                                <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                                <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                ...
                <li class="media result-3">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"><a href="">Suparman - Pembantu rumah tangga</a></h4>
                        <div class="result-toggle">
                            <article>
                                <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
