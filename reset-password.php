        ...
        <div class="panel">
            <form class="form-center form-horizontal" method="post" action="" name="" role="form">
                ...
                <div class="form-group has-error">
                    <input type="password" class="form-control" id="" name="" placeholder="Enter your old password">
                    <span class="control-label">This field is required.</span>
                </div>
                <div class="form-group has-error">
                    <input type="password" class="form-control" id="" name="" placeholder="Enter your new password">
                    <span class="control-label">This field is required.</span>
                </div>
                <div class="form-group has-error">
                    <input type="password" class="form-control" id="" name="" placeholder="Confirm your new password">
                    <span class="control-label">This field is required.</span>
                </div>
